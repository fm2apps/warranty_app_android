...
/**
 * Created by heat on 5/4/2017.
 */

public class ImagePicker extends AlertDialog implements View.OnClickListener {
    ...
    public ImagePicker(int attachRequestCode, int cameraRequestCode, String imageName,
    ...
    public void onClick(View view) {
        String Id = activity.getResources().getResourceName(view.getId());
        if (Id.contains("gallery")) {
            Intent i = new Intent(Intent.ACTION_PICK, MediaStore.Images.Media.EXTERNAL_CONTENT_URI);
            i.setType("image/*");
            i.setAction(Intent.ACTION_GET_CONTENT);
            if (activity != null)
                activity.startActivityForResult(i, attachRequestCode);
